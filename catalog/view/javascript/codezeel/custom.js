...
$(document).ready(function(){
	...
	// Increase Decrease quantity value with input type number
...
function menuResponsive(){
	...
	if ($(window).width() < 992){
		...
		//Append land-curr in menu
		$('.lang-curr').appendTo('.menu-langcurr');
		...
		//Append lang-curr in header
		$('.lang-curr').appendTo('#top-links');
	}
